...
public class AdminBookingdetails extends AppCompatActivity {
    ...
    ImageView imageView;
    String Key,status,status2="You cancelled the booking",status3="Booking is cancelled from the Vendor side",UID,Imageurl;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_admin_bookingdetails);
        checkConnection();
        ...
        if (status.equals("Booking is cancelled from the Customer side")){
    ...
    public void Dialogcancel(){
        ...
        builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                //   checkConnection();
                final ProgressDialog progressDialog=new ProgressDialog(AdminBookingdetails.this);
...
//
                ...
                FirebaseDatabase.getInstance().getReference("All Bookings")
                    ...
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(AdminBookingdetails.this, "Booking is not cancelled", Toast.LENGTH_SHORT).show();
                    }
                });
                progressDialog.dismiss();
                Toast.makeText(AdminBookingdetails.this, "Your Booking is cancelled ", Toast.LENGTH_SHORT).show();
    ...
    public void Dialogdelete(){
        ...
        builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                progressDialog.show();
                final DatabaseReference databaseReference2= FirebaseDatabase.getInstance().getReference("All Bookings");
                databaseReference2.child(Key).removeValue();
                progressDialog.dismiss();
                Toast.makeText(AdminBookingdetails.this, "Your booking deleted", Toast.LENGTH_SHORT).show();
                //  startActivity(new Intent(getApplicationContext(),Allorders.class));
                finish();
            }
        });
    ...
    public void checkConnection(){
        ...
        View view=findViewById(R.id.adminbookdetails);
